...
int main(int argc, const char* argv[])
{
    ...
    // Find file size.
    //
    // Note I should check the return values from fseek, but I am going to
    // skip error checking for this and other functions from now on i.e.
    // do not do this in code you ship.
